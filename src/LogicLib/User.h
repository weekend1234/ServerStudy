...
namespace NLogicLib
{
	...
	public:
		...
		bool IsConfirmed() { return m_IsAuthConfirm;  }
	...
	protected:
		short m_Index = -1; //UserPool에서 몇 번째인지
		int m_SessionIndex = -1; //연결된 세션 중 몇 번째인지

		std::string m_ID = "";
		
		bool m_IsAuthConfirm = false;
